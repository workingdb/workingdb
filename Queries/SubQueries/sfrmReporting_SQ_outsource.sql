SELECT tblPartInfo.partNumber, tblPartInfo.description, tblDropDownsSP.partType, tblPartInfo.SOPdate, tblPartOutsourceInfo.outsourceVendor, rnotes.reportNote, rnotes.recordId AS noteId, rnotes.updatedBy, rnotes.updateddate, rnotes.dataTag0, getCustomername([customerid]) AS customer, grabGatePlannedDate([partNumber],3) AS outsourcedate, Left(getCurrentGate([partNumber]),2) AS gate
